...
exports.book_create_get = asyncHandler(async (req, res, next) => {
  ...
  res.render('book_form', {title:'Create Books', authors:allAuthors, genres:allGenres});
});
...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
  ...
  const [book, bookInstances] = await Promise.all([Book.findById(req.params.id), BookInstance.find({book:req.params.id})]);
  res.render('book_delete', {title:'Delete Book', book:book, bookInstances:bookInstances});
});
